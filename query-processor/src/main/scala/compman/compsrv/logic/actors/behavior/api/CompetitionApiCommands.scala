...
object CompetitionApiCommands {
  ...
  final case class GetCompetitionInfo(competitionId: String)(override val replyTo: ActorRef[QueryServiceResponse])
      extends CompetitionApiCommand {}

  final case class PutCompetitionInfo(competitionId: String, competitionInfo: Array[Byte])

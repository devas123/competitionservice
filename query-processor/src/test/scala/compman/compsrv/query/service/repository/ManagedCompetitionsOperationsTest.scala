...
import compman.compsrv.query.service.repository.ManagedCompetitionsOperations.{QuillCassandraEnvironment, Service}
...
object ManagedCompetitionsOperationsTest extends DefaultRunnableSpec {
  ...
  override def spec: ZSpec[Any, Throwable] =
    suite("managed competitions operations suite")(testM("should save managed competition") {

...
class MatGlobalCommandExecutorTransformer(stateStoreName: String,
    ...
    override fun updateCorrelationId(currentState: CompetitionDashboardState, command: Command): CompetitionDashboardState = currentState.copy(correlationId = command.correlationId!!)
                ...
                if (state == null) {
                    if (competitionProperties != null) {
                        ...
                        if (periods?.isEmpty() == false) {
                            ...
                            val newState = CompetitionDashboardState(command.correlationId!!, competitionProperties.competitionId, dbPeriods.toSet(), competitionProperties)

...
@Component
class SagaExecutionService(private val aggregateServiceFactory: AggregateServiceFactory, private val categoryGeneratorService: CategoryGeneratorService, mapper: ObjectMapper, validators: List<PayloadValidator>) : ValidatedCommandExecutor<AbstractAggregate>(mapper, validators) {

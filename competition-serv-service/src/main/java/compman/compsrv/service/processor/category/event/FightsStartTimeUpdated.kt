...
class FightsStartTimeUpdated(
    ...
    override fun applyEvent(
        ...
        return executeValidated<FightStartTimeUpdatedPayload, Category>(event) { payload, _ ->
    ...
    fun Category.fightStartTimeUpdated(payload: FightStartTimeUpdatedPayload, mats: Array<MatDescriptionDTO>): Category {

...
class CategoryGeneratorService {
    fun adultMaleRooster() = CategoryDescriptorDTO("BJJ", AgeDivisionDTO.ADULT, Gender.MALE.name, WeightDTO(IDGenerator.hashString(WeightDTO.ROOSTER), BigDecimal("57.5")).setName(WeightDTO.ROOSTER), BeltType.WHITE, UUID.randomUUID().toString(), BigDecimal(5), emptyArray())
    fun adultFemaleRooster() = CategoryDescriptorDTO("BJJ", AgeDivisionDTO.ADULT, Gender.FEMALE.name, WeightDTO(IDGenerator.hashString(WeightDTO.ROOSTER), BigDecimal("48.5")).setName(WeightDTO.ROOSTER), BeltType.WHITE, UUID.randomUUID().toString(), BigDecimal(5), emptyArray())
    fun createDefaultBjjCategories(competitionId: String): List<CategoryDescriptorDTO> {
        fun adultMaleLightFeather() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.LIGHT_FEATHER), BigDecimal("64")).setName(WeightDTO.LIGHT_FEATHER))
        fun adultMaleFeather() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.FEATHER), BigDecimal("70")).setName(WeightDTO.FEATHER))
        fun adultMaleLight() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.LIGHT), BigDecimal("76")).setName(WeightDTO.LIGHT))
        fun adultMaleMiddle() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.MIDDLE), BigDecimal("82.3")).setName(WeightDTO.MIDDLE))
        fun adultMaleMiddleHeavy() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.MEDIUM_HEAVY), BigDecimal("88.3")).setName(WeightDTO.MEDIUM_HEAVY))
        fun adultMaleHeavy() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.HEAVY), BigDecimal("94.3")).setName(WeightDTO.HEAVY))
        fun adultMaleSuperHeavy() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.SUPER_HEAVY), BigDecimal("100.5")).setName(WeightDTO.SUPER_HEAVY))
        fun adultMaleUltraHeavy() = adultMaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.ULTRA_HEAVY), BigDecimal("300")).setName(WeightDTO.ULTRA_HEAVY))

        fun adultFemaleLightFeather() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.LIGHT_FEATHER), BigDecimal("53.5")).setName(WeightDTO.LIGHT_FEATHER))
        fun adultFemaleFeather() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.FEATHER), BigDecimal("58.5")).setName(WeightDTO.FEATHER))
        fun adultFemaleLight() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.LIGHT), BigDecimal("64")).setName(WeightDTO.LIGHT))
        fun adultFemaleMiddle() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.MIDDLE), BigDecimal("69")).setName(WeightDTO.MIDDLE))
        fun adultFemaleMiddleHeavy() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.MEDIUM_HEAVY), BigDecimal("74")).setName(WeightDTO.MEDIUM_HEAVY))
        fun adultFemaleHeavy() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.HEAVY), BigDecimal("79.3")).setName(WeightDTO.HEAVY))
        fun adultFemaleSuperHeavy() = adultFemaleRooster().setWeight(WeightDTO(IDGenerator.hashString(WeightDTO.SUPER_HEAVY), BigDecimal("300")).setName(WeightDTO.SUPER_HEAVY))

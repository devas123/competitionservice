...
@JsonCreator @PersistenceConstructor constructor(
        @Id @JsonProperty("name") val name: String,
        @JsonProperty("minimalAge") val minimalAge: Int,
        @JsonProperty("maximalAge") val maximalAge: Int) {

...
public class AgeDivisionDTO {
    public static final String MIGHTY_MITE_I = "MIGHTY MITE I";
    public static final String MIGHTY_MITE_II = "MIGHTY MITE II";
    public static final String MIGHTY_MITE_III = "MIGHTY MITE III";
    public static final String PEE_WEE_I = "PEE WEE I";
    public static final String PEE_WEE_II = "PEE WEE II";
    public static final String PEE_WEE_III = "PEE WEE III";
    public static final String JUNIOR_I = "JUNIOR I";
    public static final String JUNIOR_II = "JUNIOR II";
    public static final String JUNIOR_III = "JUNIOR III";
    public static final String TEEN_I = "TEEN I";
    public static final String TEEN_II = "TEEN II";
    public static final String TEEN_III = "TEEN III";
    public static final String JUVENILE_I = "JUVENILE I";
    public static final String JUVENILE_II = "JUVENILE II";
    public static final String ADULT = "ADULT";
    public static final String MASTER_1 = "MASTER 1";
    public static final String MASTER_2 = "MASTER 2";
    public static final String MASTER_3 = "MASTER 3";
    public static final String MASTER_4 = "MASTER 4";
    public static final String MASTER_5 = "MASTER 5";
    public static final String MASTER_6 = "MASTER 6";
